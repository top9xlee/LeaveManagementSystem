            ...
            <div class="m-stack m-stack--hor m-stack--desktop">
                <div class="m-stack__item m-stack__item--fluid">
                    <div class="m-login__wrapper">
                        <c:choose>
                            <c:when test="${param.get('error').equals('passwordNotMatch')}">
                                <p class="message-register" style="color: rgb(22, 161, 255); font-size: 25px;text-align: center">Mật khẩu không trùng khớp</p>
                            </c:when>
                        </c:choose>
                        ...
                        <div class="m-login__signin">
                            ...
                            <form class="m-login__form m-form" action="/doForget" method="post" enctype="multipart/form-data">
