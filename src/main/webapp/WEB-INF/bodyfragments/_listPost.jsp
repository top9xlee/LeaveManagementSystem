    ...
    <div class="m-grid__item m-grid__item--fluid m-grid m-grid--ver-desktop m-grid--desktop m-body">
        ...
        <table width="100%"class="table table-striped- table-bordered table-hover table-checkable dataTable no-footer table" style="overflow: scroll" >
            ...
            <tr>
                ...
                <th title="Field #8" data-field="DepositPaid" style="margin: auto">Tình trạng đơn</th>
            ...
            <c:forEach var="absens" items="${absens}" varStatus="loopCounter">
                ...
                <tr>
                    ...
                    <td ><c:if test="${absens.enablePost == 0 }">
                        <a href="/enable-absence/${absens.postId}" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill" title="Phê duyệt"
