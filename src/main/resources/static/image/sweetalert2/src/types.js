/**
 * @typedef { import('static/image/sweetalert2/src/sweetalert2').default } SweetAlert2
 * @typedef { import('static/image/sweetalert2/src/sweetalert2').SweetAlertOptions } SweetAlertOptions
 */
